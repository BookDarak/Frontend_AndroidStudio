package com.cookandroid.bookdarak_1.di
...
import com.cookandroid.bookdarak_1.util.constants.BASE_URL
import com.cookandroid.bookdarak_1.util.constants.DATASTORE_NAME
...
@Module
    ...
    object AppModule {
        ...
        @Singleton
        @Provides
        fun provideApiService(retrofit: Retrofit): FindBookAPI {
            return retrofit.create(FindBookAPI::class.java)
        }
